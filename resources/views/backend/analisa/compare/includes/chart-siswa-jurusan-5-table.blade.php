        ...
        <table class="table table-striped table-bordered table-jurusan">
            <thead>
                <tr>
                    ...
                    <th colspan="2" v-for="(value, index) in chartSiswaAktifJurusan.dataSets" v-if="index < 5">
                        @{{ value.label }}
                    </th>
                </tr>
                <tr>
                    <template colspan="2" v-for="(value, index) in chartSiswaAktifJurusan.dataSets" v-if="index < 5">
            ...
            <tbody>
                <tr v-for="(label, index) in labels">
                    ...
                    <template v-for="(value, indexSiswa) in chartSiswaAktifJurusan.dataSets" v-if="indexSiswa < 5">
...
<div class="col-md-12">
        <table class="table table-striped table-bordered table-jurusan">
            <thead>
                <tr>
                    <th rowspan="2">Periode</th>
                    <th colspan="2" v-for="(value, index) in chartSiswaAktifJurusan.dataSets" v-if="index > 4">
                        @{{ value.label }}
                    </th>
                </tr>
                <tr>
                    <template colspan="2" v-for="(value, index) in chartSiswaAktifJurusan.dataSets" v-if="index > 4">
                        <th>@{{ labels[0].split(" / ")[1] }}</th>
                        <th>@{{ labels[labels.length - 1].split(" / ")[1] }}</th>
                    </template>
                </tr>
            ...
            <tbody>
                <tr v-for="(label, index) in labels">
                    <td v-if="index % 2 == 0">@{{ label.split(" / ")[0] }}</td>
                    <template v-for="(value, indexSiswa) in chartSiswaAktifJurusan.dataSets" v-if="indexSiswa > 4">
                        <td align="right" v-if="index % 2 == 0">
                            @{{ chartSiswaAktifJurusan.dataSets[indexSiswa].data[index] | numeral('0,0') }}
                        </td>
                        <td align="right" v-if="index % 2 == 0">
