<?php
// ----------------------------------------------------------------------------
namespace App\Http\Controllers\Backend\Report\Top5;
// ----------------------------------------------------------------------------
...
class Top5Controller extends Controller
{
    ...
    public function index()
    {
        ...
        // --------------------------------------------------------------------
        return view('backend.report.top5.index', (array) $data);
        // --------------------------------------------------------------------
    }
    // ------------------------------------------------------------------------
    ...
    public function export(Request $request){
        ...
        // ----------------------------------------------------------------
        return view('pdf.report.top5', (array) $data);
    }
    ...
    public function getDataSetPenerimaan($periode, $year = null){
        ...
        // --------------------------------------------------------------------
        $labels = [];
        $top5   = $query->limit(5)->pluck('cabang_id')->toArray();
        for($i = 0; $i < count($top5); $i++){
            $cabang     = Cabang::find($top5[$i]);
            $labels[]   = $cabang->nama;
        }
        // --------------------------------------------------------------------
        $totalPendaftaran = [];
    ...
    public function getDataSetSiswaAktifJurusan($periode, $year = null){
        ...
        // --------------------------------------------------------------------
        $labels = [];
        $top5   = $relationship->limit(5)->pluck('cabang_id')->toArray();
        for($i = 0; $i < count($top5); $i++){
            $cabang     = Cabang::find($top5[$i]);
            $labels[]   = $cabang->nama;
        }
