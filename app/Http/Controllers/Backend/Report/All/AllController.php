<?php
// ----------------------------------------------------------------------------
namespace App\Http\Controllers\Backend\Report\All;
// ----------------------------------------------------------------------------
...
class AllController extends Controller
{
    ...
    public function index()
    {
        ...
        // --------------------------------------------------------------------
        return view('backend.report.all.index', (array) $data);
        // --------------------------------------------------------------------
    }
    // ------------------------------------------------------------------------
    ...
    public function export(Request $request){
        ...
        $data->cabang = "ALL";
        // ----------------------------------------------------------------
        return view('pdf.report.all', (array) $data);
    }
